      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        ...
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text"><img src="images/i12.png">Gestão de <span class="text-black fw-bold">Aluno</span></h1>
            <h3 class="welcome-sub-text">Ver a lista de alunos que fizeram cadastro </h3>
          </li>
        </ul>
        <!--Fechar header-->
...
if(isset($_POST['cadaluno']))
{
    ...
    $anolect = $_POST['txtanolect'];
    $datanasc = $_POST['txtdatanasc'];
    $encarregado = $_POST['encarregado'];

    $sql = "INSERT INTO `tb_aluno`(`nome_al`, `telefone_al`, `email_al`, `curso_al`, `classe_al`, `turma_al`, `ano_lectivo_al`, `morada_al`, `data_nascimento`, `id_encarregado`) VALUES ('$nome','$telefone',' $email',' $curso ','$classe',' $turma','$anolect',' $morada','$datanasc','$encarregado')";
    $result = mysqli_query($conexao,$sql);
                ...
                <div class="card-body">
                  ...
                  <form method="post" class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="txttelefone" name="txttelefone" placeholder="Telefone" Required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <strong><label for="Curso">Curso</label></strong>
                      <input type="text" class="form-control" id="txtcurso" name="txtcurso" placeholder="Curso" Required>
                    </div>
                    <div class="form-group">
                      <strong><label for="Classe">Classe</label></strong>
                      <input type="number" class="form-control" id="txtclasse" name="txtclasse" placeholder="Classe">
                    </div>
                    <div class="form-group">
                      <strong><label for="Turma">Turma</label></strong>
                      <input type="text" class="form-control" id="txtturma" name="txtturma" placeholder="Turma">
                    </div>
                    <div class="form-group">
                      <strong><label for="AnoLec">Ano Lectivo</label></strong>
                      <input type="number" class="form-control" id="txtanolect" name="txtanolect" placeholder="Anolect" Required>
                    </div>
                    <div class="form-group" style = "width: 35%;">
                      <strong><label for="Datanasc">Data de Nascimento</label></strong>
                      <input type="date" class="form-control" id="txtdatanasc" name="txtdatanasc" placeholder="Datanasc" Required>
                    </div>
                    <div class="form-group">
                      <strong><label for="Encarregado">Selecione Encarregado</label></strong>
                      
                      <!--Selecionar nome e valor do id encarregado-->
                           <select name="encarregado" id="encarregado" class="form-control">
                                <?php
                                    $sql1 = "SELECT * FROM tb_encarregado ORDER BY nome_enc DESC";
                                    $result1 = $conexao->query($sql1);
                                    while($dados1 = mysqli_fetch_assoc($result1))
                                    {
                                    ?>
                                        <option value="<?php echo $dados1['id_encarregado'] ?>"><?php echo $dados1['nome_enc'] ?></option>
                                    <?php 
                                    }
                                ?>
                           </select>
                    ...
                    <button type="submit" id="cadaluno" name="cadaluno" class="btn btn-outline-primary btn-fw">Salvar</button>
                  </form>
                </div>
              </div>
            </div>                    
...
<div class="col-lg-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title"><img src="images/t3.png"> Alunos</h4>
                      <p class="card-description">
                      <code> Lista dos alunos</code>
                      </p>
                      ...
                      <tbody>
                        ...
                        <?php
                        $sql = "SELECT * FROM `tb_aluno` INNER JOIN tb_encarregado ON tb_aluno.id_encarregado=tb_encarregado.id_encarregado ORDER BY id_aluno DESC LIMIT 15";
                        ...
                        while($user_data = mysqli_fetch_assoc($result))
                        {
                          ...
                          <?php
                            ...
                            ?>
                            <!--Editar e excluir-->
                            <td><a href="Page_Cliente_Editar.php?id=<?php echo $user_data['id_aluno']?>" class="btn btn-outline-warning btn-fw"><img src="images/t1.png"></a></td>

                            <td><a href="Page_Cliente_Excluir.php?id=<?php echo $user_data['id_aluno']?>"
                             class="btn btn-outline-danger btn-fw" onclick="return confirm('Excluir Aluno ?')"><img src="images/t2.png"></a></td>
